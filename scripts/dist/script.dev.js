...
var completedTasksColumn = document.getElementById("completedTasksColumn");
...
function addTask() {
  ...
  console.log(taskList); // Add checkbox to each task
  ...
  newTask.appendChild(btnDiv); //Add Date Label

  var currentDateLabel = document.createElement("span");
  currentDateLabel.classList.add("label", "date");
  currentDateLabel.innerHTML = ' <i class="fas fa-flag"></i>' + getCurrentDate();
